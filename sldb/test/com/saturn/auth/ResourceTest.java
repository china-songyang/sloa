...
public class ResourceTest {
	...
	public void testResource() {
		Resource resource = new Resource("test.resource", "resourcer", "/root/test", "test.parentId", null, null, null);
		...
		Resource resource2 = new Resource("test.resource2", "resourcer2", "/root/test2", "test.parentId2", null, null,null);
