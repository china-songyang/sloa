...
<body>
	<form id="form1" runat="server" action="" method="post">
		...
		<center>
		<input type="button" style="width:60px;height:26px;margin-right: 865px;" onclick="javascript:history.back(-1)" value="返回">
		<p>
...
<table width="927" style="border-left:1px solid black; border-top:1px solid black;" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000">
  ...
  <tr>
    <td height="26" colspan="10" nowrap="nowrap">&nbsp;&nbsp;救助金额：${society. money}</td>
  </tr>
  <tr>
