	...
	<script type="text/javascript">
		$(function() {
			$('#queryTable').datagrid({
				...
				url : '<%=request.getContextPath()%>/app/sldb/lsybjzxt/listLsjzybxtState.action',
				idField : 'id',//唯一标识列
				sortName : 'id',
				sortOrder : 'desc',
				remoteSort : true,
		...
		function applyVO(id){
			window.location.href='<%=request.getContextPath()%>/app/sldb/society/applyLsybjzxt.action?id='+ id+'&type=1';
			return false;
		}
		function endVO(id){
