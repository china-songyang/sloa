...
<body>
	<form id="editForm"  action="<%=request.getContextPath()%>/app/sldb/lsybjzxt/update.action" method="post">
		...
		<a href="#" onclick="window.location.href='<%=request.getContextPath()%>/app/sldb/lsybjzxt/apply/show.jsp'" class="easyui-linkbutton" id="Button2">返   回</a>
		<p>
