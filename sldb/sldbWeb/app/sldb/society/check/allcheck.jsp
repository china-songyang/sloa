			...
			$('#queryTable').datagrid({
				...
				},'-',
				{
					...
					handler : function() {
						...
						$.messager.confirm('确认核对项', '确认核对该选项', function(result){
							window.location.href='<%=request.getContextPath()%>/app/sldb/check/tobeCheck.jsp?type=23&ids='+ ids;
						});
						return false;
					}
				},'-',
				{
					...
					handler : function() {
						...
						$.messager.confirm('确认核对项', '确认核对该选项', function(result){
							window.location.href='<%=request.getContextPath()%>/app/sldb/check/tobeCheck.jsp?type=24&ids='+ ids;
						});
						return false;
					}
				},'-',
				{
					...
					handler : function() {
						...
						$.messager.confirm('确认核对项', '确认核对该选项', function(result){
							window.location.href='<%=request.getContextPath()%>/app/sldb/check/tobeCheck.jsp?type=25&ids='+ ids;
						});
						return false;
					}
				}]
