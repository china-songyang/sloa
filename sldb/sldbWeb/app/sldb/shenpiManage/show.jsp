...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<script type="text/javascript">
		...
		function refuseVO(id){
			$.messager.confirm('确认报废', '确认报废该选项', function(result){
				if (result){
					window.location.href='<%=request.getContextPath()%>/app/sldb/shenpiManage/baofei.jsp?ids=' + id+'&type=1';
				}
			});
			return false;
		}
