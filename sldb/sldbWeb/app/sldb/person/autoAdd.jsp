...
<body>
	<form id="form1" runat="server" action="<%=request.getContextPath()%>/app/sldb/society/add.action" method="post">
		...
		<table border="1" cellpadding="0" cellspacing="0" bordercolor="#000000">
		  ...
		  <tr height="26">
		    ...
		    <td><div align="center"><span class="STYLE4"><input id="name" type="text" name="name" /></span></div></td>
		    <td><div align="center"><span class="STYLE4">性别</span></div></td>
		    <td><div align="center"><span class="STYLE4"><input id="sex" type="text" name="sex" /></span></div></td>
		    <td><div align="center"><span class="STYLE4">身份证号码</span></div></td>
		    <td colspan="2"><div align="center"><span class="STYLE4"><input id="identify" type="text" name="identify" /></span></div></td>
		    <td rowspan="3" colspan="2"><div align="center"><span class="STYLE4"><img src="" style="width: 91px; height: 108px" id="picture" name="picture" /></span></div></td>
		  </tr>
		   <tr height="26">
		    <td><div align="center"><span class="STYLE4">婚姻状况</span></div></td>
		    <td><div align="center"><span class="STYLE4"><input id="marry" type="text" name="marry" /></span></div></td>
		    <td><div align="center"><span class="STYLE4">患病名称</span></div></td>
		    <td><div align="center"><span class="STYLE4"><input id="ill" type="text" name="ill" /></span></div></td>
		    <td><div align="center"><span class="STYLE4">残疾类别<br>和等级</span></div></td>
		    <td colspan="2"><div align="center"><span class="STYLE4"><input id="disability" type="text" name="disability" /></span></div></td>
		  </tr>
		  <tr height="26">
		    <td><div align="center"><span class="STYLE4">家庭人口</span></div></td>
		    <td><div align="center"><span class="STYLE4"><input id="family" type="text" name="family" /></span></div></td>
		    <td colspan="2"><div align="center"><span class="STYLE4">劳动能力</span></div></td>
		    <td><div align="center"><span class="STYLE4"><input id="labor" type="text" name="labor" /></span></div></td>
		    <td width="8%"><div align="center"><span class="STYLE4">家庭类别</span></div></td>
		    <td><div align="center"><span class="STYLE4"><input id="familyClass" type="text" name="familyClass" /></span></div></td>
		  </tr>
		  <tr height="26">
		    <td><div align="center"><span class="STYLE4">家庭总收入<br>（元/年）</span></div></td>
		    <td><div align="center"><span class="STYLE4"><input id="total" type="text" name="total" /></span></div></td>
		    <td><div align="center"><span class="STYLE4">收入来源</span></div></td>
		    <td colspan="5"><div align="center"><span class="STYLE4"><input id="income" type="text" name="income" /></span></div></td>
		  </tr>
		   <tr height="26">
		    <td><div align="center"><span class="STYLE4">家庭总支出<br>（元/年）</span></div></td>
		    <td><div align="center"><span class="STYLE4"><input id="spending" type="text" name="spending" /></span></div></td>
		    <td><div align="center"><span class="STYLE4">支出用途</span></div></td>
		    <td colspan="5"><div align="center"><span class="STYLE4"><input id="purpose" type="text" name="purpose" /></span></div></td>
		  </tr>
		  <tr height="26">
		    <td><div align="center"><span class="STYLE4">户口类型</span></div></td>
		    <td><div align="center"><span class="STYLE4"><input id="accountType" type="text" name="accountType" /></span></div></td>
		    <td><div align="center"><span class="STYLE4">家庭住址</span></div></td>
		    <td colspan="5"><div align="center"><span class="STYLE4"><input id="address" type="text" name="address" /></span></div></td>
		  </tr>
		  <tr height="26">
		   ...
		   <tr height="26">
		    <td ><div align="center"><span class="STYLE4"><input id="c_name" type="text" name="c_name" /></span></div></td>
		    <td ><div align="center"><span class="STYLE4"><input id="c_sex" type="text" name="c_sex" /></span></div></td>
		    <td ><div align="center"><span class="STYLE4"><input id="c_identify" type="text" name="c_identify" /></span></div></td>
		 	<td ><div align="center"><span class="STYLE4"><input id="c_relation" type="text" name="c_relation" /></span></div></td>
		    <td ><div align="center"><span class="STYLE4"><input id="c_marry" type="text" name="c_marry" /></span></div></td>
		    <td ><div align="center"><span class="STYLE4"><input id="c_ill" type="text" name="c_ill" /></span></div></td>
		    <td ><div align="center"><span class="STYLE4"><input id="c_disability" type="text" name="c_disability" /></span></div></td>
		    <td ><div align="center"><span class="STYLE4"><input id="c_labor" type="text" name="c_labor" /></span></div></td>
		  </tr>
		   <tr height="26">
		     <td ><div align="center"><span class="STYLE4"><input id="c_name" type="text" name="c_name" /></span></div></td>
		    <td ><div align="center"><span class="STYLE4"><input id="c_sex" type="text" name="c_sex" /></span></div></td>
		 ...
		 <tr>
		    <td><div align="center"><span class="STYLE4">申请<br>理由</span></div></td>
		  	<td colspan="9" height="160"><div align="center"><span class="STYLE4"><textarea id="cause" name="cause" style="overflow-x:hidden;overflow-y:hidden;border:none"/></textarea>　</span></div></td>
		  </tr>
		  <tr>
	 	...
	 	<tr height="40">
	 		<td colspan=8><div align="left"><span class="STYLE4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;救助金额:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="money" type="text" name="money" /></span></div></td>
	 	</tr>
  </table>
  </center>
