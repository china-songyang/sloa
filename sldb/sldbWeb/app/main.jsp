...
<body class="easyui-layout" onload="show()">
	<div region="north" split="false"
		...
		<div class="top_img">
	    <div class="user-info" style="float:right;margin-right:-150px;color:#fff">${authUser.name}    　[<a href="<%=request.getContextPath()%>/app/nameLogin.jsp"><font style="color:#fff">退出</font></a>] </div>
