...
public class ListTempByTotalAction implements IAction{
	@Override
	public IView execute(HttpServletRequest request,
		...
		if("21".equals(userOragantion.getOrganizationId())){
			ListData<Temporary> data = Temporary.getAllWithSelect(vo, dataGridInfo.getStartPage(),
	...
	public String requestMapping() {
		return "/app/sldb/temp/listTempByTotal.action";
	}
}
