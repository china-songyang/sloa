...
public class PersonState {
	...
	//  获得审批时间  jyb
	public static PersonState getCreateTime(String identify, String state) {
		return SimpleDaoTemplate.queryOne(
				"SELECT * FROM sldb_person_state WHERE state = '"+ state +"' and identify = '" + identify + "'",
	...
	public static ListData<PersonState> getAll(PersonState vo, String start,
		...
		return SimpleDaoTemplate.query("SELECT * FROM sldb_person_state WHERE 1 = 1",
				new DymaticCondition().addCondition("and pid = '?'", vo.getPid())
						.addCondition("and type = '?'", vo.getType()).addCondition("ORDER BY {0} {1}", orderBy, order),
